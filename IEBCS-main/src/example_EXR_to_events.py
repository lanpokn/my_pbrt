...
def Compare_Real_and_PBES(Realpath, simPath):
    ...
    point_cloud = events_data.display_events_3D(ev_data0,21500,22000)
    View_3D(point_cloud)
    point_cloud = events_data.display_events_3D(ev_data1,21500,22000)
    View_3D(point_cloud)
    img1 = events_data.display_events(ev_data0,21500,23500)
    cv2.imshow("real",img1)
    cv2.waitKey()
    img2 = events_data.display_events(ev_data1,21500,23500)
    cv2.imshow("sim",img2)
    cv2.waitKey()
    #chamfer
...
# Compare_Real_and_PBES("D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/LOW_360_120deg.hdf5",'D:/2023/computional imaging/my_pbrt/output/Rotate_360_high/R_360_H_ICNS.dat')
