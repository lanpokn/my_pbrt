...
def Compare_Real_and_PBES(Realpath, simPath,time_intervel = 100000):
    ...
    # point_cloud = events_data.display_events_3D(ev_data0,20000,24000)
    # View_3D(point_cloud)
    # point_cloud = events_data.display_events_3D(ev_data1,20000,24000)
    # View_3D(point_cloud)
    # img1 = events_data.display_events(ev_data0,20000,30000)
    # cv2.imshow("real",img1)
    # cv2.waitKey()
    # img2 = events_data.display_events(ev_data1,20000,30000)
    # cv2.imshow("sim",img2)
    # cv2.waitKey()
